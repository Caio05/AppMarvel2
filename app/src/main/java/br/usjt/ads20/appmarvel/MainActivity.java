package br.usjt.ads20.appmarvel;
...
public class MainActivity extends AppCompatActivity {
    ...
    public static final String HEROIS = "br.usjt.ads20.appfilmes.filmes";
    ...
    private class DownloadJsonFilmes extends AsyncTask<String, Void, ArrayList<Filme>>{
        ...
        protected ArrayList<Filme> doInBackground(String... strings) {
            ArrayList<Filme> herois = new ArrayList<>();
            ArrayList<Poster> imagens = new ArrayList<>();
            try {
                herois = HeroiNetwork.buscarHeroi(strings[0]);
